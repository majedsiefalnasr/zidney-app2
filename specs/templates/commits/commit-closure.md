...
Step: Closure (7/7) Stage: {{STAGE_NAME}} Phase: {{PHASE_NAME}} Status: PRODUCTION READY

Tasks: {{TASKS_COMPLETED}}/{{TASKS_TOTAL}} completed Risk: {{RISK_LEVEL}}

─── Scope Delivered ─────────────────────────────────────── {{SCOPE_ITEM_1}} {{SCOPE_ITEM_2}}
{{SCOPE_ITEM_3}} {{SCOPE_ITEM_4}}
...
reports/ANALYZE_REPORT.md reports/IMPLEMENT_REPORT.md reports/CLOSURE_REPORT.md TESTING_GUIDE.md
PR_SUMMARY.md README.md
