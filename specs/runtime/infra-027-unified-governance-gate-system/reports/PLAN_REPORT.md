...
| 9   | SKILL.md updated as in-scope INFRA-27 deliverable                                                                               | Following Architecture Guardian ruling — aligns naming policy with actual usage, prevents `validate:script:naming` CI failures |
