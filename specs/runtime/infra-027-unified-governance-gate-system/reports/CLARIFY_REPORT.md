...
| --- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Q1  | Canonical script names for all 6 composed guards            | Corrected: `validate:scripts:runtime`, `validate:scripts:usage`, `infra:security:ci`; `ai-context:validate` needs alias chaining `validate:ai-context-fresh && validate:ai-context-schemas`                                     | HIGH — FR-001 corrected                               |
