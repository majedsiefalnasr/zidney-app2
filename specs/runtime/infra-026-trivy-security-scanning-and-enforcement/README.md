# Trivy Security Scanning And Enforcement
...
| Workflow State    | Orchestrator | specs/runtime/infra-026-trivy-security-scanning-and-enforcement/.workflow-state.json | Pre-Step     |
