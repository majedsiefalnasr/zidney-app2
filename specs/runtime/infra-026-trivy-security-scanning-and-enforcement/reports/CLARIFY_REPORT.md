...
| 2   | Trivy version pinning      | Pin to latest stable at implementation time (e.g. `v0.59.1`). Version recorded in CI YAML; local install docs reference same version                        | SC-001, NFR-006, Risk: version drift                 |
