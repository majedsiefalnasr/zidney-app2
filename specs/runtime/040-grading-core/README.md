...
**Stage File:** `specs/phases/03_BACKOFFICE_CORE/04_EXAM_ENGINE_CORE/STAGE_40_GRADING_CORE.md`
...
| Plan      | ✅     | plan.md, data-model.md      | reports/PLAN_REPORT.md      |
...
| Workflow State    | Orchestrator | specs/runtime/040-grading-core/.workflow-state.json | Pre-Step     |
