...
- [x] T005 Run `bun run validate:runtime:scripts` and confirm it exits 0 after T003 changes — verifies all 5 new script keys map to existing or newly-registered files; **blocks Phase 3 if this fails** — no file changes, terminal verification only
