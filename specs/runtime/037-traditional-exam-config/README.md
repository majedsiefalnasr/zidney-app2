...
**Stage File:** `specs/phases/03_BACKOFFICE_CORE/04_EXAM_ENGINE_CORE/STAGE_37_TRADITIONAL_EXAM_CONFIG.md`
...
| Workflow State    | Orchestrator | specs/runtime/037-traditional-exam-config/.workflow-state.json | Pre-Step     |
