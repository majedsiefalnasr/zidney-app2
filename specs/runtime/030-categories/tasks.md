...
**Independent test criteria**: `bun run test packages/domain-core/src/categories` and `bun run test apps/api/src/routes/backoffice/categories` both pass with zero failures.
