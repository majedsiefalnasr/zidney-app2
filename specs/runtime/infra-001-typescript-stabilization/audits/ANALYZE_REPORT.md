...
| C3       | Success criterion gap   | SC-07 stated "automated config audit" but no task existed to create it                                       | CRITICAL | 1     | T087 added: creates `scripts/validate/check-tsconfig-strict.sh` CI script                            |
