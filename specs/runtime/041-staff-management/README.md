...
**Phase:** PHASE_03_BACKOFFICE_CORE / 05_USER_MANAGEMENT
...
| Plan      | ✅     | plan.md, reports.md, etc.   | reports/PLAN_REPORT.md      |
...
| Workflow State    | Orchestrator | specs/runtime/041-staff-management/.workflow-state.json | Pre-Step     |
