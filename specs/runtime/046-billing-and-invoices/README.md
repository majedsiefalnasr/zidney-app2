...
| Plan      | ✅        | plan.md, reports/PLAN_REPORT.md | reports/PLAN_REPORT.md      |
...
| Workflow State    | Orchestrator | specs/runtime/046-billing-and-invoices/.workflow-state.json | Pre-Step     |
