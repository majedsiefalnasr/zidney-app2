...
**Stage File:** `specs/phases/03_BACKOFFICE_CORE/04_EXAM_ENGINE_CORE/STAGE_39_AUTO_SELECTION_ENGINE.md`
...
| Workflow State    | Orchestrator | specs/runtime/039-auto-selection-engine/.workflow-state.json | Pre-Step     |
