# STAGE FIX 02 — Policy Engine Bootstrap Minimal
...
| Workflow State    | Orchestrator | specs/runtime/fix-02-policy-engine-bootstrap-minimal/.workflow-state.json | Pre-Step     |
