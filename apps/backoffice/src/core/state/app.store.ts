...
export const useBackofficeAppStore = defineStore(
  'backoffice-app',
  () => {
    // ── State ──────────────────────────────────────────────────────────────
...
if ((import.meta as any).hot) {
  ;(import.meta as any).hot.accept(acceptHMRUpdate(useBackofficeAppStore, (import.meta as any).hot))
}
