/**
 * Plans Routes — Helpers
 *
 * File: apps/api/src/routes/backoffice/plans/helpers.ts
 * Stage: STAGE_44_PLANS_AND_SUBSCRIPTIONS
 *
 * Shared utilities, context extractors, and error response builder for plans routes.
 */

import type { AuditContext, DbClient } from '@zidney/domain-core/plans'
import { PLAN_ERROR_HTTP, PlanError } from '@zidney/domain-core/plans'
...
export function planErrorResponse(c: Context, err: unknown) {
  ...
  logger.error('Unhandled plans error', {
