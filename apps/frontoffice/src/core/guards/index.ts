/**
 * Guard pipeline barrel for Frontoffice.
 ...
 * 4. FeatureFlagGuard
 *
 * OBS-02 fix: router.onError redirects to errorRouteName ('fo-error'), NOT unauthorizedRouteName.
...
const logger = createLogger('frontoffice:guards')
...
export interface RegisterGuardsOptions {
  ...
  /** Login route name. Frontoffice: 'fo-login' */
  loginRouteName: string
  /** Dashboard route name. Frontoffice: 'fo-home' */
  dashboardRouteName: string
  /** Callback returning the user's role, or undefined if not authenticated */
  getUserRole: () => string | undefined
  /** Unauthorized route name. Frontoffice: 'fo-unauthorized' */
  unauthorizedRouteName: string
  /** Error route name. Frontoffice: 'fo-error' (OBS-02: used for router.onError redirect) */
