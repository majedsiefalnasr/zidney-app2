/**
 * Pinia reactive auth state store for Frontoffice.
...
const AUTH_STORE_ID = 'frontoffice-auth' as const
 ...
 * @param loginRouteName - App-specific login route name (e.g. 'fo-login')
...
/**
 * Component accessor composable for the Frontoffice auth store.
 ...
 */
export const useFrontofficeAuthStore = defineStore(AUTH_STORE_ID, () => ({
