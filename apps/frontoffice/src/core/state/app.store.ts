...
export const useFrontofficeAppStore = defineStore(
  'frontoffice-app',
  () => {
    // ── State ──────────────────────────────────────────────────────────────
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useFrontofficeAppStore, import.meta.hot))
}
