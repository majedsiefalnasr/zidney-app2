...
export default defineConfig([
  {
    ...
    rules: {
      ...
      // Disallow cross-app imports from mmc or backoffice
          ...
          zones: [
            {
              ...
              from: '../../mmc/src',
              message:
                'Frontoffice must not import from apps/mmc. Cross-app imports are forbidden.',
            },
            {
              target: './src',
              from: '../../backoffice/src',
              message:
                'Frontoffice must not import from apps/backoffice. Cross-app imports are forbidden.',
            },
            {
