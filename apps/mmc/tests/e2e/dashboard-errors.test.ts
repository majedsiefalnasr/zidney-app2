...
describe('T064: E2E Authorization & Error Scenarios', () => {
  ...
  describe('Permission Enforcement', () => {
    ...
    it('should return 403 for insufficient permissions', async () => {
      ...
      const result = await makeRequest(
        'GET',
        '/summary',
        'Bearer token-without-permission'
      )
  ...
  describe('Rate Limiting', () => {
    ...
    it('should return 429 when rate limited', async () => {
      ...
      expect(hasAny(200) || hasAny(401) || hasAny(403) || hasAny(429)).toBe(
        true
      )
    })
  ...
  describe('Parameter Validation', () => {
    it('should validate pagination parameters', async () => {
      const result = await makeRequest(
        'GET',
        '/geographic?page=-1&limit=invalid',
        'Bearer test'
      )
  ...
  describe('Cross-Tenant Isolation', () => {
    ...
    it('should isolate data per tenant', async () => {
      ...
      expect(results.every((r) => [200, 401, 403].includes(r.status))).toBe(
        true
      )
    })
  })
