...
import { looksLikeToken } from '../../../../../apps/backoffice/src/core/auth/token-redact'
import type { AuthUser } from '../../../../../apps/backoffice/src/core/auth/types'
...
describe('token persistence audit (backoffice) — no token reaches Web Storage', () => {
