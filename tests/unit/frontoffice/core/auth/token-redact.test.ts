/**
 * Unit tests for apps/frontoffice/src/core/auth/token-redact.ts
...
} from '../../../../../apps/frontoffice/src/core/auth/token-redact'
...
describe('redactSensitiveFields (frontoffice)', () => {
  ...
  it('does not modify safe fields', () => {
    const input = { userId: '123', email: 'user@example.com', role: 'student' }
    const result = redactSensitiveFields(input)
...
describe('looksLikeToken (frontoffice)', () => {
...
describe('assertNoTokenInLogArgs helper (frontoffice)', () => {
