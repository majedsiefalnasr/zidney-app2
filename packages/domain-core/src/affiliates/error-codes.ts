...
export const AffiliateErrorMessages: Record<AffiliateErrorCode, string> = {
  [AffiliateErrorCode.AFFILIATE_CODE_NOT_FOUND]:
    'Affiliate code not found or inactive',
  [AffiliateErrorCode.AFFILIATE_CODE_INACTIVE]:
    'Affiliate code has been disabled',
  [AffiliateErrorCode.AFFILIATE_CODE_EXPIRED]: 'Affiliate code has expired',
  [AffiliateErrorCode.AFFILIATE_USAGE_LIMIT_EXCEEDED]:
    'Affiliate code has reached its usage limit',
  ...
  [AffiliateErrorCode.AFFILIATE_INVALID_DATE_RANGE]:
    'Start date must be before end date',
  [AffiliateErrorCode.AFFILIATE_INVALID_USAGE_LIMITS]:
    'Usage limits must be null or non-negative',
}
