/**
 * Traditional Questions — Dependency Registry
 *
 * File: packages/domain-core/src/traditional-questions/traditional-questions.dependency-registry.ts
 ...
 * deletion is immediately blocked with a 409 TRAD_QUESTION_REFERENCED_IN_ACTIVE_ATTEMPT.
 */

import type { DbClient } from './traditional-questions.types'
