...
- Check the `docs/architecture/ADR/` directory for existing ADRs
...
- Save the file to `docs/architecture/ADR/` with proper naming convention
...
All ADRs must be saved in: `docs/architecture/ADR/`
...
1. ADR file is created in `docs/architecture/ADR/` with correct naming
