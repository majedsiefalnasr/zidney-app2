...
**Context artifact:** `docs/ai/context/gitnexus-context.json` — regenerate with `bun run gitnexus:context`, validate with `bun run gitnexus:validate`. Refresh if >24h old.
