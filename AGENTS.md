...
**Note:** Local CI Simulation Gate requirements are documented in `.agents/agents/zidney-orchestrator.agent.md`
as a mandatory prerequisite before executing Step 7 — Closure.
