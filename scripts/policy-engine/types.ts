 ...
 *
 * Single source of truth for all TypeScript interfaces used by the engine.
...
export interface PolicyContext {
   ...
   * subprocess cancellation on engine timeout.
   */
...
export interface PolicyResult {
  ...
  line?: number
  /** Column number within the file, if applicable. */
  column?: number
